...
abstract class ProveedorServiceBase{
  ...
  Future<Result<PaginateData<ProveedorView>>> verProveedores({int? pagina = 1, int? limite = 5, String? nombre, String? tipoProveedor});
  ...
  Future<Result<PaginateData<TypeProveedor>>> verTiposDeProveedor({int? pagina = 1, int? limite = 5, String? nombre});
